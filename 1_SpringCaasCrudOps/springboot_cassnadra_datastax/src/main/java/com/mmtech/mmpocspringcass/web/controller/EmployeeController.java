...
import com.mmtech.mmpocspringcass.data.repository.EmployeeRepository;
import com.mmtech.mmpocspringcass.exceptions.ResourceNotFoundException;
...
public class EmployeeController {
	...
	public ResponseEntity<Employee> updateEmployee(
		...
		//Employee employee = employeeRepository.findOne(employeeId)	.orElseThrow(() -> new ResourceNotFoundException("Employee not found for this id :: " + employeeId));
		Employee employee =employeeRepository.findOne(employeeId);
